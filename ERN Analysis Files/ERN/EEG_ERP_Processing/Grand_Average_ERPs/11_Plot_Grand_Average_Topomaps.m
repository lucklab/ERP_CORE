...
%Set mean amplitude time window in milliseconds (e.g., 0 to 100 ms)
timewindow = [0 100];
...
myclim = [-3.5 10.5; -3.5 10.5; -10 0];

%Open EEGLAB and ERPLAB Toolboxes  
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;

%Load the grand average ERP waveforms outputted from Script #9 in ERPLAB format
ERP = pop_loaderp('filename', 'GA_ERN_erp_ar_diff_waves.erp', 'filepath', Current_File_Path);  
...
save2pdf([Current_File_Path filesep 'GA_ERN_Topomaps.pdf']);
close all
