...
ERPset_list = fullfile(Current_File_Path, 'GA_ERN_erp_ar_diff_waves.txt');
...
ERP = pop_savemyerp(ERP, 'erpname', 'GA_ERN_erp_ar_diff_waves', 'filename', 'GA_ERN_erp_ar_diff_waves.erp', 'filepath', Current_File_Path, 'Warning', 'off');
...
ERPset_list = fullfile(Current_File_Path, 'GA_ERN_erp_ar_diff_waves_lpfilt.txt');
fid = fopen(ERPset_list, 'w');
    for i = 1:length(SUB)
        Subject_Path = [DIR filesep SUB{i} filesep];
...
%Create a grand average ERP waveform
ERP = pop_gaverager( ERPset_list , 'ExcludeNullBin', 'on', 'SEM', 'on' );
ERP = pop_savemyerp(ERP, 'erpname', 'GA_ERN_erp_ar_diff_waves_lpfilt', 'filename', 'GA_ERN_erp_ar_diff_waves_lpfilt.erp', 'filepath', Current_File_Path, 'Warning', 'off');
