...
fid = fopen(fullfile(Current_File_Path, 'Baseline_Noise_N170.csv'), 'w');
...
for i = 1:length(SUB)
    ...
    ERP = pop_loaderp('filename', [SUB{i} '_N170_erp_ar_diff_waves.erp'], 'filepath', Subject_Path); 
    ...
    ERP = pop_loaderp('filename', [SUB{i} '_N170_erp_ar_diff_waves_lpfilt.erp'], 'filepath', Subject_Path); 
...
baseline_noise_table = readtable([Current_File_Path filesep 'Baseline_Noise_N170.csv']); 
...
save2pdf([Current_File_Path filesep 'N170_Baseline_Noise_Unfiltered.pdf']);
close all
...
%Save baseline noise plots to pdf
save2pdf([Current_File_Path filesep 'N170_Baseline_Noise_Filtered.pdf']);
close all
