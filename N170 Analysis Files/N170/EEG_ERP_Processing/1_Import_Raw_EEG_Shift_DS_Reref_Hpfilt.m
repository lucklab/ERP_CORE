...
%all 33 EEG channels, creates bipolar HEOG and VEOG channels, adds channel location information, removes the DC offsets, and applies a high-pass filter. 
...
for i = 1:length(SUB)
    ...
    EEG = pop_loadset( 'filename', [SUB{i} '_N170.set'], 'filepath', Subject_Path);
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1, 'setname', [SUB{i} '_N170'], 'gui', 'off'); 
    ...
    EEG  = pop_erplabShiftEventCodes( EEG , 'DisplayEEG', 0, 'DisplayFeedback', 'summary', 'Eventcodes', [1:80, 100:180], 'Rounding', 'earlier', 'Timeshift',  26 );
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2,'setname', [SUB{i} '_N170_shifted'],'savenew',[Subject_Path SUB{i} '_N170_shifted.set'] ,'gui','off'); 
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'setname',[SUB{i} '_N170_shifted_ds'],'savenew',[Subject_Path SUB{i} '_N170_shifted_ds.set'] ,'gui','off'); 
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 4, 'setname', [SUB{i} '_N170_shifted_ds_reref_ucbip'], 'savenew', [Subject_Path SUB{i} '_N170_shifted_ds_reref_ucbip.set'], 'gui', 'off');
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 5, 'setname', [SUB{i} '_N170_shifted_ds_reref_ucbip_hpfilt'], 'savenew', [Subject_Path SUB{i} '_N170_shifted_ds_reref_ucbip_hpfilt.set'], 'gui', 'off');
