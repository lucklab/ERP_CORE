...
for i = 1:length(SUB)
    ...
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_Parent_Waves.pdf']);
    close all
    ...
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_Difference_Wave.pdf']);
    close all
    ...
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_Parent_Waves_All_Channels.pdf']);
    close all
    ...
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_Difference_Wave_All_Channels.pdf']);
    close all
  
    %Plot the parent (faces and cars conditions) ICA-corrected and uncorrected bipolar HEOG signals 
    ERP = pop_ploterps( ERP, [1 2], [32 34] , 'Box', [1 2], 'blc', baselinecorr, 'Maximize', 'on', 'Style', 'Classic', 'xscale', xscale,  'yscale', yscale_HEOG);
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_HEOG.pdf']);
    close all
    ...
    save2pdf([Subject_Path 'graphs' filesep SUB{i} '_N170_VEOG.pdf']);
    close all
