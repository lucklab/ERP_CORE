...
%Set mean amplitude time window in milliseconds (e.g., 110 to 150 ms)
timewindow = [110 150];
...
myclim = [-3 4; -3 4; -3.5 3.5];

%Open EEGLAB and ERPLAB Toolboxes  
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;

%Load the grand average ERP waveforms outputted from Script #9 in ERPLAB format
ERP = pop_loaderp('filename', 'GA_N170_erp_ar_diff_waves.erp', 'filepath', Current_File_Path);  
...
save2pdf([Current_File_Path filesep 'GA_N170_Topomaps.pdf']);
close all
