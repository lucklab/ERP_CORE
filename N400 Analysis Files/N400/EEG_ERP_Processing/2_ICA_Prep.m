...
for i = 1:length(SUB)
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1, 'setname', [SUB{i} '_N400_shifted_ds_reref_ucbip_hpfilt'], 'gui', 'off'); 
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2, 'setname', [SUB{i} '_N400_shifted_ds_reref_ucbip_hpfilt_ica_prep1'], 'savenew', [Subject_Path SUB{i} '_N400_shifted_ds_reref_ucbip_hpfilt_ica_prep1.set'], 'gui', 'off'); 
    ...
    [ndata, text, alldata] = xlsread([Current_File_Path filesep 'ICA_Prep_Values_N400']); 
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3, 'setname', [SUB{i} '_N400_shifted_ds_reref_ucbip_hpfilt_ica_prep2'], 'savenew', [Subject_Path SUB{i} '_N400_shifted_ds_reref_ucbip_hpfilt_ica_prep2.set'], 'gui', 'off'); 
