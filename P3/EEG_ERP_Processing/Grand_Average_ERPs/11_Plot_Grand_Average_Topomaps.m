...
myclim = [-2 12; -2 12; -2 7];

%Open EEGLAB and ERPLAB Toolboxes  
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;

%Load the grand average ERP waveforms outputted from Script #9 in ERPLAB format
ERP = pop_loaderp('filename', 'GA_P3_erp_ar_diff_waves.erp', 'filepath', Current_File_Path);  
...
save2pdf([Current_File_Path filesep 'GA_P3_Topomaps.pdf']);
close all
