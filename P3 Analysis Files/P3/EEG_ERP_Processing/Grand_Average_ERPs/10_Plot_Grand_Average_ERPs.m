...
yscale_EEG_diff = [-21.0 14.0   -21:7:14];
...
ERP = pop_loaderp('filename', 'GA_P3_erp_ar_diff_waves_lpfilt.erp', 'filepath', Current_File_Path);    
...
save2pdf([Current_File_Path filesep 'GA_P3_Parent_Waves.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_Difference_Wave.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_Difference_Wave_SEM.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_Parent_Waves_All_Channels.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_Difference_Wave_All_Channels.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_HEOG.pdf']);
close all
...
save2pdf([Current_File_Path filesep 'GA_P3_VEOG.pdf']);
close all
