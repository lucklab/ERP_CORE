...
Xranges = {0:2:18, 0.5:3:27.5, 292.5:35:607.5, 340:20:530, 227.5:35:542.5};
...
for m = 1:length(Measures)
    ...
    Meas_file = [Current_File_Path filesep meas '_Diff_Waves_P3.txt'];
    ...
    save2pdf([Current_File_Path filesep meas '_Histogram_P3.pdf']);
    close all
