...
Xranges = {-7.5:1:1.5, -10.75:1.5:2.75, 195:10:285, 222.5:5:267.5, 100:20:280};
...
for m = 1:length(Measures)
    ...
    Meas_file = [Current_File_Path filesep meas '_Diff_Waves_N2pc.txt'];
    ...
    save2pdf([Current_File_Path filesep meas '_Histogram_N2pc.pdf']);
    close all
