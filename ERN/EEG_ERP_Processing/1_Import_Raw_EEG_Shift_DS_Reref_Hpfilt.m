...
for i = 1:length(SUB)
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2,'setname', [SUB{i} '_ERN_shifted'],'savenew',[Subject_Path SUB{i} '_ERN_shifted.set'] ,'gui','off'); 
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'setname',[SUB{i} '_ERN_shifted_ds'],'savenew',[Subject_Path SUB{i} '_ERN_shifted_ds.set'] ,'gui','off'); 
    ...
    EEG = pop_eegchanoperator( EEG, [Current_File_Path filesep 'Rereference_Add_Uncorrected_Bipolars_ERN.txt']);
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 4, 'setname', [SUB{i} '_ERN_shifted_ds_reref_ucbip'], 'savenew', [Subject_Path SUB{i} '_ERN_shifted_ds_reref_ucbip.set'], 'gui', 'off');
    ...
    [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 5, 'setname', [SUB{i} '_ERN_shifted_ds_reref_ucbip_hpfilt'], 'savenew', [Subject_Path SUB{i} '_ERN_shifted_ds_reref_ucbip_hpfilt.set'], 'gui', 'off');
