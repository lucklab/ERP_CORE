...
Xranges = {-13:2:5, -19.25:2.5:3.25, 107.5:5:152.5, 107.5:5:152.5, 7.5:15:142.5};
...
for m = 1:length(Measures)
    ...
    Meas_file = [Current_File_Path filesep meas '_Diff_Waves_N170.txt'];
    ...
    save2pdf([Current_File_Path filesep meas '_Histogram_N170.pdf']);
    close all
