...
myclim = [-1 9; -1 9; -7.5 0.5];

%Open EEGLAB and ERPLAB Toolboxes  
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;

%Load the grand average ERP waveforms outputted from Script #9 in ERPLAB format
ERP = pop_loaderp('filename', 'GA_N400_erp_ar_diff_waves.erp', 'filepath', Current_File_Path);  
...
save2pdf([Current_File_Path filesep 'GA_N400_Topomaps.pdf']);
close all
