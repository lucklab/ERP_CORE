...
ERPset_list = fullfile(Current_File_Path, 'GA_N2pc_erp_ar_diff_waves.txt');
fid = fopen(ERPset_list, 'w');
    for i = 1:length(SUB)
        Subject_Path = [DIR filesep SUB{i} filesep];
        erppath = [Subject_Path SUB{i} '_N2pc_erp_ar_diff_waves.erp'];
        fprintf(fid,'%s\n', erppath);
    end
fclose(fid);
...
ERP = pop_savemyerp(ERP, 'erpname', 'GA_N2pc_erp_ar_diff_waves', 'filename', 'GA_N2pc_erp_ar_diff_waves.erp', 'filepath', Current_File_Path, 'Warning', 'off');
...
ERPset_list = fullfile(Current_File_Path, 'GA_N2pc_erp_ar_diff_waves_lpfilt.txt');
fid = fopen(ERPset_list, 'w');
    for i = 1:length(SUB)
        Subject_Path = [DIR filesep SUB{i} filesep];
        erppath = [Subject_Path SUB{i} '_N2pc_erp_ar_diff_waves_lpfilt.erp'];
        fprintf(fid,'%s\n', erppath);
    end
fclose(fid);
...
%Create a grand average ERP waveform
ERP = pop_gaverager( ERPset_list , 'ExcludeNullBin', 'on', 'SEM', 'on' );
ERP = pop_savemyerp(ERP, 'erpname', 'GA_N2pc_erp_ar_diff_waves_lpfilt', 'filename', 'GA_N2pc_erp_ar_diff_waves_lpfilt.erp', 'filepath', Current_File_Path, 'Warning', 'off');
...
%Create a text file containing a list of ERPsets and their file locations to include in the grand average ERP waveforms
ERPset_list = fullfile(Current_File_Path, 'GA_N2pc_erp_ar.txt');
fid = fopen(ERPset_list, 'w');
    for i = 1:length(SUB)
        Subject_Path = [DIR filesep SUB{i} filesep];
        erppath = [Subject_Path SUB{i} '_N2pc_erp_ar.erp'];
        fprintf(fid,'%s\n', erppath);
    end
fclose(fid);
...
%Create a grand average ERP waveform
ERP = pop_gaverager( ERPset_list , 'ExcludeNullBin', 'on', 'SEM', 'on' );
ERP = pop_savemyerp(ERP, 'erpname', 'GA_N2pc_erp_ar', 'filename', 'GA_N2pc_erp_ar.erp', 'filepath', Current_File_Path, 'Warning', 'off');
...
ERP = pop_savemyerp(ERP, 'erpname', 'GA_N2pc_erp_ar_lpfilt', 'filename', 'GA_N2pc_erp_ar_lpfilt.erp', 'filepath', Current_File_Path, 'Warning', 'off');%*************************************************************************************************************************************
