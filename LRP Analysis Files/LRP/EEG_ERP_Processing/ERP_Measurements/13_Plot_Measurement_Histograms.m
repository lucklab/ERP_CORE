...
Xranges = {-4.25:0.5:0, -8.5:1:0.5, -91:8:-19, -74.75:5.5:-25.25, -172.5:15:-37.5};
...
for m = 1:length(Measures)
    ...
    Meas_file = [Current_File_Path filesep meas '_Diff_Waves_LRP.txt'];
    ...
    save2pdf([Current_File_Path filesep meas '_Histogram_LRP.pdf']);
    close all
