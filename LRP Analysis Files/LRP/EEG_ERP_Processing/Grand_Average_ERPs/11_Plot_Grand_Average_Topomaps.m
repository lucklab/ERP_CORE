...
%Set mean amplitude time window in milliseconds (e.g., -100 to 0 ms)
timewindow = [-100 0];
...
myclim = [1 6; 1 6; -2.5 0];

%Open EEGLAB and ERPLAB Toolboxes  
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;

%Load the grand average ERP waveforms outputted from Script #9 in ERPLAB format
ERP = pop_loaderp('filename', 'GA_LRP_erp_ar_diff_waves.erp', 'filepath', Current_File_Path);  
...
save2pdf([Current_File_Path filesep 'GA_LRP_Topomaps.pdf']);
close all
